...
using LexiconMVCBlogNew.Data;
using LexiconMVCBlogNew.Models;

namespace LexiconMVCBlogNew.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,CreationTime,postId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,CreationTime,postId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
